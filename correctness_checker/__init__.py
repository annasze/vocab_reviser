...
def adjust_strings(ignore_capitalization: bool,
...
def evaluate_user_input(ignore_capitalization: bool,
                        ignore_punctuation: bool,
                        correct_answer: str,
                        user_input: str) -> tuple[float, bool]:
